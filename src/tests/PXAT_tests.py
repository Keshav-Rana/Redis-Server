...
class PXAT_tests(unittest.TestCase):
    def setUp(self):
    ...
    def test_normalCase(self):
        ...
        input_cmd = f"SET ten 10 PXAT {unixTime}"
    ...
    def test_zeroSeconds(self): 
        ...
        input_cmd = f"SET zero 0 PXAT {unixTime}"
        serialised_input = f"*5\r\n$3\r\nSET\r\n$4\r\nzero\r\n$1\r\n0\r\n$4\r\nPXAT\r\n${len(str(unixTime))}\r\n{unixTime}\r\n"
        self.assertEqual(self.resp_service.serialiser(input_cmd), serialised_input)
    ...
    def test_negativeSeconds(self):
        ...
        input_cmd = f"SET negative -1 PXAT {unixTime}"
        serialised_input = f"*5\r\n$3\r\nSET\r\n$8\r\nnegative\r\n$2\r\n-1\r\n$4\r\nPXAT\r\n${len(str(unixTime))}\r\n{unixTime}\r\n"
        self.assertEqual(self.resp_service.serialiser(input_cmd), serialised_input)
    ...
    def test_invalidInput(self):
        input_cmd = "SET invalid inv PXAT invalid"
        serialised_input = "*5\r\n$3\r\nSET\r\n$7\r\ninvalid\r\n$3\r\ninv\r\n$4\r\nPXAT\r\n$7\r\ninvalid\r\n"
        self.assertEqual(self.resp_service.serialiser(input_cmd), serialised_input)
